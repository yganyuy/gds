...
const Utils := preload("res://addons/ChineseNodeSelector/qr/utils.gd")
const ReedSolomonGenerator := preload("res://addons/ChineseNodeSelector/qr/reed_solomon_generator.gd")
